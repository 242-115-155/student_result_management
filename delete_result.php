...
<head>
    ...
    <title>Delete Result - Metropolitan University</title>
...
<body>
    ...
    <div class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="active"><a href="delete_result.php"><i class="fa-solid fa-trash-can"></i> Delete Result</a></li>
                ...
                <form method="POST" action="delete_result.php">
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            <span class="input-group-text bg-light"><i class="fa-solid fa-user-minus text-muted"></i></span>
                    ...
                    <button type="submit" name="search" class="btn btn-primary px-4 fw-semibold w-100" style="border-radius: 8px;">
                        <i class="fa-solid fa-search me-2"></i> Search Result
                    </button>
                </form>
            </div>
                ...
                <?php while($row = mysqli_fetch_assoc($result)): ?>
                    <div class="form-card border-start border-danger border-4">
                        <div class="d-flex align-items-center gap-2 mb-3">
                            ...
                            <h5 class="m-0 fw-bold text-dark">Confirm Deletion</h5>
                        </div>
                        
                        <div class="data-row">
                            <strong>Student ID:</strong> <span class="text-dark ms-1"><?php echo $row['student_id']; ?></span>
                        </div>
                        <div class="data-row">
                            <strong>Course Code:</strong> <span class="text-dark ms-1"><?php echo $row['course_code']; ?></span>
                        </div>
                        ...
                        <a href="delete_single_result.php?id=<?php echo $row['result_id']; ?>" 
                           ...
                           onclick="return confirm('Are you absolutely sure you want to delete this result?');">
